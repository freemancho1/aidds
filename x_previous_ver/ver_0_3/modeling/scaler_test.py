...
from aidds_buy.sys.utils.data_io import save_data, read_data
...
class Scaling:
    ...
    def _split_xy(self):
        ...
        try:
            ...
            # x, y 값 분리
            self._data['x']['all'] = self._ppdf[['acc_no']+training_cols].copy()
    ...
    def _scaling(self, id=None):
        ...
        try:
            ...
            # acc_no빼고 다 스케일링
            cols_to_scale = train_x.columns.tolist()[1:]
