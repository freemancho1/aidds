...
class PreprocessingModule:
    def cons(self, pdf=None):
        try:
            ...
            raise AiddsException('PP_CONS_MD', se_msg=e)
    ...
    def calculate(self, soc_df=None, fdict=None):
        try:
            ...
            raise AiddsException('PP_CALCULATE_MD', se_msg=e)
    ...
    def pole(self, sdf=None):
        try:
            ...
            raise AiddsException('PP_POLE_MD', se_msg=e)
    ...
    def line(self, sdf=None):
        try:
            ...
            raise AiddsException('PP_LINE_MD', se_msg=e)
    ...
    def sl(self, sdf=None):
        try:
            ...
            raise AiddsException('PP_SL_MD', se_msg=e)
    ...
    def calculate_sum(self, df, cols, pdf):
        try:
            ...
            raise AiddsException('PP_CALCULATE_SUM', se_msg=e)
